...
See `windmill/templates/azure-vms-collector.ts` in the `sightline-prism-windmill` repository for the Windmill deployment template. [Install Windmill](/docs/prism/install/windmill) covers the setup.
